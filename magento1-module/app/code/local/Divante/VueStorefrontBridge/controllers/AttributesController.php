    ...
    public function indexAction()
    {
        if ($this->_authorizeAdminUser($this->getRequest())) {
            ...
            foreach ($productAttrs as $productAttr) {
                ...
                $productAttrDTO['is_visible_on_front'] = $productAttrDTO['is_visible_on_front'] ? "1" : "0";
                $productAttrDTO['default_frontend_label'] = $productAttrDTO['frontend_label'];
